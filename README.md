...
- The instructions of setting up are given in [__Setting up Python portable assistant.md](https://github.com/kiwi0fruit/python-portable-assistant/blob/master/__Setting%20up%20Python%20portable%20assistant.md).
