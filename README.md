...
* The templates `setup.py` files already have:
  ...
  * Sample code of PyQt (and any other developer-specified module) stopper that fixes GPL licensing issues was added to the [`app.py`](template_app/app/app/app.py),
